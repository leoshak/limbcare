...
class QuestionsForumController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('doctor.question_forum.index',compact('questionsforum') );
    ...
    public function store(Qeestionval $request)
    {
        ...
        if($em=="")
        {
            ...
            return redirect()->intended(route('doctor.question_forum.add'))->with('message', $message);
    ...
    {
        return view('doctor.question_forum.show',['questionsforum' => $questionsforum]);
    }
    ...
    {
        return view('doctor.question_forum.edit',['questionsforum' => $questionsforum]);
    }
    ...
    public function destroy(QuestionsForum $questionsforum)
    {
        ...
        return view('doctor.question_forum.delete',['questionsforum' => $questionsforum]);
    }
