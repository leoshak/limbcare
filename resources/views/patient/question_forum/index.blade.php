...
@section('content')
    <div class="row title-section">
        ...
        <div class="col-8 col-md-4" style="padding-bottom: 15px;">
            <div class="topicbar">
                <a href="{{ route('patient.question_forum.add') }}" class="btn btn-primary">Add Question</a>
            </div>
                ...
                <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                    ...
                    @foreach($questionsforum as $questionsforum)
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-xs btn-primary" href="{{ route('patient.question_forum.show',[$questionsforum->id]) }}">
                                    <i class="fa fa-eye"></i>
                                </a>
