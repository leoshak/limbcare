...
class AppointmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('employee.director.appointments.index', compact('appointments'));
    }
    ...
    {
        return view('employee.director.appointments.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        Appointment::create($request->all());
            return redirect()->route('employee.director.appointments')->with('message', 'Appointment added successfully!');
    }
    ...
    {
        return view('employee.director.appointments.show', ['appointment' => $appointment]);
    }
    ...
    {
        return view('employee.director.appointments.edit', ['appointment' => $appointment, 'roles' => Role::get()]);
    }
    ...
    public function update(Request $request, Appointment $appointment)
    {
        ...
        return redirect()->intended(route('employee.director.appointments'))->with('message', $message);
    }
    ...
    public function destroy(Appointment $appointment)
    {
        ...
        $appointment->delete();
        return redirect()->route('employee.director.appointments')->with('message', $message);
    }
}
