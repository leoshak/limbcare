...
class DiagnosisController extends Controller
{
    ...
    {
        return view('patient.diagnosis.add');
    }
    /**
    ...
    public function update(DiagnosisValUpdate $request,Diagnosis $diagnosise)
    {
        ...
        DB::table('diagnosis')
            ...
            return view('patient.diagnosis.success');
    }
    ...
    {
        return view('patient.diagnosis.show',['diagnosis' => $diagnosis]);
    }
    /**
    ...
    {
        return view('patient.diagnosis.edit',['diagnosis' => $diagnosis]);
    }
    ...
    {
        return view('patient.diagnosis.delete',['diagnosis' => $diagnosis]);
    }
}