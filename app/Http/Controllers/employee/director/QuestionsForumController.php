...
class QuestionsForumController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('employee.director.question_forum.index',compact('questionsforum') );
    ...
    {
        return view('employee.director.question_forum.add');
    }
    public function add()
    {
        return view('employee.director.question_forum.add');
    ...
    public function store(Qeestionval $request)
    {
        ...
        if($em=="")
        {
            ...
            return redirect()->intended(route('employee.director.question_forum.add'))->with('message', $message);
       ...
       $Questions=QuestionsForum::all();
        ...
        return view('employee.director.question_forum.success');
        }
    ...
    {
        return view('employee.director.question_forum.show',['questionsforum' => $questionsforum]);
    }
    ...
    {
        return view('employee.director.question_forum.edit',['questionsforum' => $questionsforum]);
    }
    ...
    public function destroy(QuestionsForum $questionsforum)
    {
        ...
        return view('employee.director.question_forum.delete',['questionsforum' => $questionsforum]);
    }
