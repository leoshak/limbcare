...
class AppointmentController extends Controller
{
    ...
    {
        return view('doctor.appointments.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        Appointment::create($request->all());
            return redirect()->route('doctor.appointments')->with('message', 'Appointment added successfully!');
    }
    ...
    {
        return view('doctor.appointments.show', ['appointment' => $appointment]);
    }
    ...
    {
        return view('doctor.appointments.edit', ['appointment' => $appointment, 'roles' => Role::get()]);
    }
    ...
    public function update(Request $request, Appointment $appointment)
    {
        ...
        return redirect()->intended(route('doctor.appointments'))->with('message', $message);
    }
    ...
    public function destroy(Appointment $appointment)
    {
        ...
        $appointment->delete();
        return redirect()->route('doctor.appointments')->with('message', $message);
    }
}
