                ...
                <div class="col-xs-6 col-sm-3">
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            {!! Form::open(array('route' => ['director.employees.delete', $employee->id], 'method' => 'DELETE', 'onSubmit'=> 'return confirm("Do you really want to delete?");')) !!}
                                <a href="{{ route('director.employees.show', [$employee->id]) }}" class="btn btn-link">View</a>
                                <a href="{{ route('director.employees.edit', [$employee->id]) }}" class="btn btn-success">Update</a>
